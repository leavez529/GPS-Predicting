...
def validateModel(ismi_set,steps):
    ...
    model = keras.models.load_model("./d 39.LSTM")
    y_pred = model.predict_classes(x_test)
    print(y_pred.shape)
    # y_pred = y_pred.reshape(y_pred.shape[0],steps*wid*hid)
    # y_test = y_test.reshape(y_test.shape[0],steps*wid*hid)
